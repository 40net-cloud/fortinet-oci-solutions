...
# Active/Passive High Available FortiGate pair Regional Subnet with Existing VCN, New Four Subnets, Single AD & Dual FD. 
...
The Template deploys FGv6.4.2 in A/P Regional Subnet with Existing VCN, Single Availability domains with Dual Fault domains.
...
5. Fill all the variable fields (all are mandatory) as per your requirements (Same as per Existing VCN)
