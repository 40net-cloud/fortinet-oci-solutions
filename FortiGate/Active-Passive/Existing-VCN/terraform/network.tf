...
resource "oci_core_subnet" "untrust_subnet" {
  ...
  security_list_ids   = [data.oci_core_vcn.my_vcn.default_security_list_id, oci_core_security_list.untrust-security_list.id]
  dhcp_options_id     = data.oci_core_vcn.my_vcn.default_dhcp_options_id
  dns_label           = "untrust"
}
...
resource "oci_core_subnet" "hb_subnet" {
  ...
  security_list_ids          = [data.oci_core_vcn.my_vcn.default_security_list_id, oci_core_security_list.hb_security_list.id]
  dhcp_options_id            = data.oci_core_vcn.my_vcn.default_dhcp_options_id
  dns_label                  = "hb"
  prohibit_public_ip_on_vnic = "true"
}
